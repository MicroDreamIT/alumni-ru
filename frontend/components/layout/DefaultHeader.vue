...
<template>
    <div class="container mx-auto xl:px-20 lg:px-10 px-2">
        <nav class="relative py-4 flex justify-between items-center bg-white mx-auto py-2 sm:py-4">
            <a class="text-xl leading-none" href="#">
                <span class="font-bold">University Of Rajshahi</span> | <span class="font-light italic">Alumni</span>
            </a>
            <div class="lg:hidden">
            ...
            <ul
                ...
                <li>
                    <nuxt-link class="text-sm text-gray-800 hover:text-gray-500" :to="{ name: 'index' }">Home</nuxt-link>
                </li>
                ...
                <li>
                    <nuxt-link class="text-sm text-gray-600 hover:text-gray-500" :to="{ name: 'events' }">Events</nuxt-link>
                </li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                        viewBox="0 0 24 24">
                ...
                <li>
                    <a class="text-sm text-gray-600 hover:text-gray-500">Activities</a>
                </li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                        viewBox="0 0 24 24">
                ...
                <li>
                    <a class="text-sm text-gray-600 hover:text-gray-500">Press</a>
                </li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                        viewBox="0 0 24 24">
                ...
                <li>
                    <nuxt-link :to="{ name: 'contact' }"
                        class="text-sm text-gray-600 hover:text-gray-500">Contact</nuxt-link>
                </li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                        viewBox="0 0 24 24">
