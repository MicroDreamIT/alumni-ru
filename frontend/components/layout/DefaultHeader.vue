    ...
    <div class="container mx-auto">
        <nav class="relative py-4 flex justify-between items-center bg-white mx-auto py-2 sm:py-4 lg:py-6">
            ...
            <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
                <li>
                    <nuxt-link class="text-sm text-gray-400 hover:text-gray-500" :to="{name:'index'}">Home</nuxt-link>
                </li>
                ...
                <li>
                    <nuxt-link class="text-sm text-gray-400 hover:text-gray-500" :to="{name:'events'}">Events</nuxt-link>
                </li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                         class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                ...
                <li>
                    <a class="text-sm text-gray-400 hover:text-gray-500">Activities</a>
                </li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                         class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                ...
                <li>
                    <a class="text-sm text-gray-400 hover:text-gray-500">Press</a>
                </li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                         class="w-4 h-4 current-fill" viewBox="0 0 24 24">
